      ...
      <header className={styles.header}>
        <div>
          ...
          <p className={styles.description}>
            这里集中展示当前登录账号的信息、密码修改入口，以及已经结算的个人工作量摘要。
          </p>
        </div>
      </header>

      <section className={styles.identityGrid}>
        <InfoCard label="姓名" value={currentAccount.displayName} />
        <InfoCard label="账号" value={currentAccount.accountId} />
        ...
        <InfoCard
          label="待办流程"
          value={`${currentAccount.pendingTodoCount}`}
          supporting="当前轮到你处理的审批节点数"
        />
      </section>
        ...
        <section className={styles.panel}>
          ...
          <form className={styles.form} onSubmit={handlePasswordSubmit}>
            ...
            <input
              ...
              value={newPassword}
            />
            <p className={styles.helpText}>提交后会立即生效，后续登录请使用新密码。</p>
            {feedback ? (
              <p
