...
from .routers.font_sync import router as font_sync_router
...
from src.cad import FontPreflightService, FontSyncService
...
def create_app(
    ...
    runtime = DeliverableApiRuntime(
        ...
        font_sync_service=font_sync_service,
    )
    ...
    app.include_router(font_sync_router)
