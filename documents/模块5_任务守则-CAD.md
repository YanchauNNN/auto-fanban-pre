...
1. `plot_window_only` 鎴?`plot_from_split_dwg`
...
1. 鏍￠獙 Python 鐜锛?- 浣跨敤 `E:\project\auto-fanban-pre\backend\.venv\Scripts\python.exe`

2. 鏍￠獙閰嶇疆璇诲彇锛?- 宸ヤ綔鐩綍蹇呴』鍦ㄤ粨搴撴牴 `E:\project\auto-fanban-pre`銆?
